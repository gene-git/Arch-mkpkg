...
def _check_rebuild_needed(msg, comp, info_last, info_avail):
    """
    Checkif this one soname check if triggers rebuild
    Input:
      * msg
...
def soname_rebuild_needed(mkpkg):
    ...
    # Check if sonames to be ignored
    #if soname_build and soname_build.lower() == 'never'
    #    return False
